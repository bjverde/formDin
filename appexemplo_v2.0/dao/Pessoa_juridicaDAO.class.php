...
class Pessoa_juridicaDAO 
{
    ...
    //--------------------------------------------------------------------------------
    public function insert( Pessoa_juridicaVO $objVo )
    {
        ...
        $sql = 'insert into form_exemplo.pessoa_juridica(
                                 cnpj
                                ,idpessoa
                                ,cnae
                                ,idnatureza_juridica
    ...
    //--------------------------------------------------------------------------------
    public function update ( Pessoa_juridicaVO $objVo )
    {
        $values = array( $objVo->getCnpj()
                        ,$objVo->getIdpessoa()
                        ,$objVo->getCnae()
        ...
        $sql = 'update form_exemplo.pessoa_juridica set 
                                 cnpj = ?
                                ,idpessoa = ?
                                ,cnae = ?
                                ,idnatureza_juridica = ?
                                where idpessoa_juridica = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return intval($result);
    }
    //--------------------------------------------------------------------------------
    public function delete( $id )
    {
        FormDinHelper::validateIdIsNumeric($id,__METHOD__,__LINE__);
        $values = array($id);
        $sql = 'delete from form_exemplo.pessoa_juridica where idpessoa_juridica = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return $result;
    }
    //--------------------------------------------------------------------------------
