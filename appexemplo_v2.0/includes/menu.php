...
$menu->add('83', '8', 'Município com paginador Tela', 'modulos/municipio.php', null);
$menu->add('84', '8', 'UF com paginador SQL', 'modulos/uf_paginador.php', null);
$menu->add('85', '8', 'Município com paginador SQL', 'modulos/municipio_sql.php', null);
