...
function fwSetHtmlEditor(textAreaName,saveHandler,readonly,height,width)
{
	...
	try
	{
		...
		tinyMCE.init( {
			...
			// removido style
			plugins : "safari,spellchecker,pagebreak,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,tabfocus",
			tab_focus : ':prev,:next',
			// Theme options
