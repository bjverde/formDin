...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = "Portugu\u00eas Brasileiro";  // Default keyboard layout
  this.VKI_langAdapt = true;  // Use lang attribute of input to select keyboard
  this.VKI_size = 2;  // Default keyboard size (1-5)
  this.VKI_sizeAdj = true;  // Allow user to adjust keyboard size
  this.VKI_clearPasswords = false;  // Clear password fields on focus
  //this.VKI_imageURI = "../../base/js/virtualKeyboard/keyboard.png";  // If empty string, use imageless mode
  this.VKI_imageURI = "";  // If empty string, use imageless mode
  this.VKI_clickless = 1000;  // 0 = disabled, > 0 = delay in ms
  ...
  /* ***** i18n text strings ************************************* */
  this.VKI_i18n = {
    '00': "Exibir/Esconder o Teclado Numérico",
  ...
  */
   ...
   *
   */
  VKI_attach = function(elem,showImage) {
    if (elem.getAttribute("VKI_attached")) return false;

    // eugenio
    if( showImage )
    {
    	self.VKI_imageURI = pastaBase+'js/virtualKeyboard/keyboard.png';
    }
    else
    {
    	self.VKI_imageURI="";
