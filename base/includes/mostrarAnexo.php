...
} elseif (strpos(strtoLower($arquivo), '.jpg') > 0 || strpos(strtoLower($arquivo), '.jpeg') > 0) {
    header("Content-type: application/image/jpg");
} elseif (strpos(strtoLower($arquivo), '.pdf') > 0) {
...
} elseif (strpos(strtoLower($arquivo), '.zip') > 0) {
    header("Content-type: application/zip");
} elseif (strpos(strtoLower($arquivo), '.gz') > 0) {
    header("Content-type: application/x-gzip");
} elseif (strpos(strtoLower($arquivo), '.rar') > 0) {
    header("Content-type: application/x-rar-compressed");
} elseif (strpos(strtoLower($arquivo), '.xls') > 0) {
    header("Content-type: application/ms-excel");
} elseif (strpos(strtoLower($arquivo), '.ppt') > 0) {
    header("Content-type: application/ms-powerpoint");
} elseif (strpos(strtoLower($arquivo), '.gif') > 0) {
    header("Content-type: application/image/gif");
} elseif (strpos(strtoLower($arquivo), '.bmp') > 0) {
    header("Content-type: application/image/bmp");
} elseif (strpos(strtoLower($arquivo), '.png') > 0) {
    header("Content-type: application/image/png");
} elseif (strpos(strtoLower($arquivo), '.tif') > 0) {
    header("Content-type: application/image/tif");
} elseif (strpos(strtoLower($arquivo), '.au') > 0) {
    header("Content-type: application/audio/basic");
} elseif (strpos(strtoLower($arquivo), '.aud') > 0) {
    header("Content-type: application/audio/basic");
} elseif (strpos(strtoLower($arquivo), '.wav') > 0) {
    header("Content-type: application/audio/wav");
} elseif (strpos(strtoLower($arquivo), '.mid') > 0) {
    header("Content-type: application/audio/x-mid");
} elseif (strpos(strtoLower($arquivo), '.avi') > 0) {
    header("Content-type: application/video/avi");
} elseif (strpos(strtoLower($arquivo), '.mp3') > 0) {
    header("Content-type: application/audio/mp3");
} elseif (strpos(strtoLower($arquivo), '.mpg') > 0) {
    header("Content-type: application/video/mpg");
} elseif (strpos(strtoLower($arquivo), '.mpeg') > 0) {
    header("Content-type: application/video/mpeg");
} elseif (strpos(strtoLower($arquivo), '.swf') > 0) {
