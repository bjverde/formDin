...
switch ($acao) {
    case "pesquisar":
        if ($form->validate()) {
            ...
            } elseif (class_exists('TPDOConnection') && TPDOConnection::getInstance()) {
                $where = '';
...
function defineAlineGridColumn($align)
{
    ...
    if (strtolower($align) == 'l' || strtolower($align) == 'left') {
        $align = 'left';
    } elseif (strtolower($align) == 'r' || strtolower($align) == 'right') {
        $align = 'right';
    } elseif (strtolower($align) == 'c' || strtolower($align) == 'center') {
        $align = 'center';
    } else {
        $align = 'left';
    }
        ...
        if ($aParams[ 'multiSelectKeyField' ]) {
            ...
            if (is_array($aUpdateFormFields)) {
                ...
                foreach ($aUpdateFormFields as $k1 => $v1) {
                    ...
                    if (isset($aData[ $aV[ 0 ] ])) {
                        $value = $aData[ $aV[ 0 ] ];
                    } elseif (isset($aData[ strtolower($aV[ 0 ])])) {
                        $value = $aData[ strtolower($aV[ 0 ])];
                    } elseif (isset($aData[ strtoupper($aV[ 0 ])])) {
