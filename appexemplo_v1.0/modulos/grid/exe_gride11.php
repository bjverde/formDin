...
$frm = new TForm('Exemplo de Gride "offline" 02',500,600);
...
//$frm->addHtmlGride('campo_moeda','grid/exe_gride12.php','gdx',null,null,null,null,'cod_moeda,dat_nascimento' )->setWidth(560);
