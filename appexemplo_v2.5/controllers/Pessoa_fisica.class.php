...
class Pessoa_fisica
{
    ...
    {
        $this->dao = new Pessoa_fisicaDAO($tpdo);
    }
    ...
    {
        $where=array('IDPESSOA_FISICA'=>$id);
    ...
    //--------------------------------------------------------------------------------
    public function save( Pessoa_fisicaVO $objVo )
    {
        $result = null;
        if( $objVo->getIdpessoa_fisica() ) {
            $this->validatePkNotExist( $objVo->getIdpessoa_fisica() );
